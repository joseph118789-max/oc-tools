...
# ==============================================================================
# DevOps Pipeline Workflow Manager
...
function show_help() {
    echo -e "${BOLD}DevOps Pipeline Workflow Manager${NC}"
    echo ""
...
function cmd_status() {
    echo -e "${GREEN}${BOLD}DevOps Pipeline Workflow Status${NC}"
    echo ""
...
function cmd_apply() {
    echo -e "${GREEN}${BOLD}Applying DevOps Pipeline Workflow${NC}"
    echo ""
...
function cmd_diagram() {
    echo -e "${GREEN}${BOLD}DevOps Pipeline Flow Diagram${NC}"
    echo ""
    cat << 'EOF'
                         ┌─────────────────────────────────────────┐
                         │              CTO (Architect)             │
